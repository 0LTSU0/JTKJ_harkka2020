...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
	...
	//readByte( ACCEL_XOUT_L, 14, rawData[1]);
	//readByte( ACCEL_YOUT_H, 14, rawData[2]);
	//readByte( ACCEL_YOUT_L, 14, rawData[3]);
	//readByte( ACCEL_ZOUT_H, 14, rawData[4]);
	//readByte( ACCEL_ZOUT_L, 14, rawData[5]);
	//readByte( GYRO_XOUT_H, 14, rawData[8]);
	//readByte( GYRO_XOUT_L, 14, rawData[9]);
	//readByte( GYRO_YOUT_H, 14, rawData[10]);
	//readByte( GYRO_YOUT_L, 14, rawData[11]);
	//readByte( GYRO_ZOUT_H, 14, rawData[12]);
	//readByte( GYRO_ZOUT_L, 14, rawData[13]);
